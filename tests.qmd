...
k = 2
p = 8
sample.sizes <- seq(from = 500, to = 7500, by = 1000)
test.consistency(tag, p, sample.sizes, 1:p, reps = trials)
consistency.plots <- graph.consistency(tag, p, seq(from = 500, to = 7500, by = 1000))
```
...
ggsave(file.path('Data', 'Figures', 'lineplotpanel.png'),
       plot = lineplots,
...
ggsave(file.path('Data', 'Figures', 'lineplotpanel_noiv.png'),
       plot = lineplots_noiv,
...
ggsave(file.path('Data', 'Figures', 'boxplotpanel.png'), plot = boxplotpanel,
       width = 8, height = 6, units = "in", dpi = 1200)
...
ggsave(file.path('Data', 'Figures', 'boxplotpanel_noiv.png'), plot = boxplotpanel_noiv,
       width = 8, height = 6, units = "in", dpi = 1200)
```
