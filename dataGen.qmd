...
C1 = 0.3 * t(rep(1,k))
C2 = 0.7 * t(rep(1,k))
save(k, p, communality, var_A, var_Y, n, sigma, lambda, psi, H_mean, H_covar, B, C1, C2, file = paste("param_", tag, ".RData", sep = ""))
```
