...
write.table(H_set, file = "H1.csv", row.names = FALSE, col.names = FALSE, sep = ",")
write.table(Z_set, file = "Z1.csv", row.names = FALSE, col.names = FALSE, sep = ",")
write.table(A_set, file = "A1.csv", row.names = FALSE, col.names = FALSE, sep = ",")
write.table(Y_set, file = "Y1.csv", row.names = FALSE, col.names = FALSE, sep = ",")
```